...
exports.sendOrderFeedbackEmail = sendOrderFeedbackEmail;
...
function getTransporter() {
    ...
    if (!process.env.SMTP_USER || !process.env.SMTP_PASS) {
        if (!warnedNoSmtp) {
            console.warn("[email] SMTP_USER/SMTP_PASS not set — emails will be logged to the console instead of sent. " +
...
async function sendOrderFeedbackEmail(to, firstName, orderId) {
