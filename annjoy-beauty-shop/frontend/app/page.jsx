    ...
    return (<>
      ...
      <section className="mx-auto max-w-6xl px-5 py-20">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {featuredServices.map((s) => (<Link key={s.slug} href="/services" className="card group overflow-hidden">
              <div className="relative h-40 w-full overflow-hidden">
                <SafeImage src={s.image} alt={s.name} fill className="object-cover transition-transform duration-500 group-hover:scale-105"/>
              </div>
              <div className="p-5">
      ...
      <section className="bg-blush/30 py-20">
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {featuredProducts.map((p) => (<Link key={p.slug} href="/shop" className="card group overflow-hidden bg-white">
                <div className="relative h-44 w-full overflow-hidden">
                  <SafeImage src={p.image} alt={p.name} fill className="object-cover transition-transform duration-500 group-hover:scale-105"/>
                </div>
                <div className="p-5">
      ...
      <section className="mx-auto max-w-6xl px-5 py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {testimonials.map((t) => (<div key={t.name} className="card p-6">
