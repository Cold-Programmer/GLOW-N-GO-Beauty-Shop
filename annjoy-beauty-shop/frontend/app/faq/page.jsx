...
export default function FaqPage() {
    ...
    return (<div className="mx-auto max-w-3xl px-5 py-16">
      ...
      <div className="mt-10 divide-y divide-ink/10 rounded-xl2 border border-ink/10 bg-white">
        {faqs.map((f, i) => (<div key={f.q}>
            <button onClick={() => setOpen(open === i ? null : i)} className="flex w-full items-center justify-between px-6 py-5 text-left" aria-expanded={open === i}>
