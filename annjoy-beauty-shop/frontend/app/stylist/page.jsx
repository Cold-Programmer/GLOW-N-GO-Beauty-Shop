...
export default function StylistDashboard() {
    ...
    return (<div className="mx-auto max-w-4xl px-5 py-16">
      ...
      {!loading && appointments.length === 0 && !error && (<p className="mt-10 text-center text-ink/50">No appointments assigned to you yet.</p>)}

      <div className="mt-8 space-y-4">
        {appointments.map((a) => (<div key={a.id} className="card flex flex-wrap items-center justify-between gap-4 p-5">
            <div>
            ...
            <select value={a.status} onChange={(e) => updateStatus(a.id, e.target.value)} className="rounded-md border border-ink/15 px-3 py-1.5 text-sm">
