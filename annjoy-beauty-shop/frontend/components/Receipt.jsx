...
export default function Receipt({ order }) {
    return (<div className="mx-auto max-w-sm rounded-xl2 border border-ink/10 bg-white p-6 print:border-0 print:shadow-none">
      ...
      <table className="w-full text-sm">
        <tbody>
          {order.items.map((item, i) => (<tr key={i}>
      ...
      <button onClick={() => window.print()} className="btn-primary mt-6 w-full print:hidden">
        Print receipt
      </button>
