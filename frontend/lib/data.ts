...
export interface Service {
  slug: string;
  name: string;
  category: "Hair" | "Nails" | "Makeup" | "Skin" | "Grooming";
  description: string;
  price: number; // KES
  durationMins: number;
  image: string;
...
export interface Product {
  id: string; // real database id — required for orders/checkout to work
  slug: string;
  name: string;
  category: string;
  description: string;
...
export const products: Product[] = [
  ...
  { id: "vitamin-c-serum", slug: "vitamin-c-serum", name: "Vitamin C Brightening Serum", category: "Skin Care", description: "Daily serum for an even, radiant complexion.", price: 1600, stock: 15, rating: 4.8, reviewCount: 52, image: "https://images.unsplash.com/photo-1620916297893-2c4f8bb03c11?w=800&q=80" },
