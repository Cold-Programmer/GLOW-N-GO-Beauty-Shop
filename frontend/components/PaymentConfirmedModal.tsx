 ...
 */
export default function PaymentConfirmedModal({ onClose, receiptNo }: { onClose: () => void; receiptNo?: string }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/40 p-5 backdrop-blur-sm animate-[fadeIn_0.25s_ease-out]">
