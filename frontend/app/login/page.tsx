  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-5 py-16">
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            <input
              ...
              className="w-full rounded-lg border border-ink/15 px-4 py-3 pr-16 text-sm focus:border-rosegold focus:outline-none"
            />
            <button
              type="button"
              onClick={() => setShowPassword((s) => !s)}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-ink/50 hover:text-rosegold-dark"
            >
        ...
        {needsVerification && (
          <button type="button" onClick={handleResend} className="text-sm font-medium text-rosegold-dark hover:underline">
