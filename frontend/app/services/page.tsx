...
export const metadata: Metadata = { title: "Services | GLOW 'N' GO Beauty & Cosmetics" };

const categories = ["Hair", "Nails", "Makeup", "Skin", "Grooming"] as const;
              ...
              {items.map((s) => (
                <div key={s.slug} className="card overflow-hidden">
                  ...
                  <div className="p-5">
                    ...
                    <Link
                      href={`/book-appointment?service=${s.slug}`}
