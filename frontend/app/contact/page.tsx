      ...
      <div className="mt-10 grid gap-10 md:grid-cols-2">
        <div className="space-y-6">
          ...
          <div className="card overflow-hidden">
            <iframe
              title="GLOW 'N' GO Beauty & Cosmetics location"
              className="h-56 w-full"
              loading="lazy"
              src="https://www.google.com/maps?q=Ndagani,Tharaka+Nithi+County,Kenya&output=embed"
            />
          </div>
        </div>

        {sent ? (
          <div className="card flex items-center justify-center p-10 text-center">
            <div>
